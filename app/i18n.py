...
STRINGS = {
    "en": {
        ...
        "resolve_refused": "Resolve is running but refused the connection — open Diagnostics for the fix.",
    ...
    "it": {
        ...
        "resolve_refused": "Resolve è aperto ma ha rifiutato la connessione — apri Diagnostica per il fix.",
